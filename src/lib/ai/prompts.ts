/**
 * Constructs the system instruction prompt for answer analysis.
 */
...
Competencies: ${JSON.stringify(blueprint.competencies?.map((c: any) => ({ id: c.id, name: c.name, definition: c.definition })))}
`;
...
${readingLevelContext}
    ...
    return `You are a supportive interview coach.
${questionContext}
